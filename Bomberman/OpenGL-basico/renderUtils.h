...
template<size_t N>
void renderRectangulo2d(retangulo2dss<N> rec, GLuint textura) {
...
template<size_t N>
void renderRectangulo2d(retangulo2dss<N> rec) {
...
template<size_t N>
void renderRectangulo2d(retangulo2dss<N> rec, GLuint textura,  float colores[12]) {
	glBindTexture(GL_TEXTURE_2D, textura);
	glNormalPointer(GL_FLOAT, 0, rec.normales);
